...
public class BubbleBombModel extends EntityModel<BubbleBombEntity> {
    private final ModelRenderer bubble;
    private final Random random = new Random();
    private int entityId;

    public BubbleBombModel() {
        texWidth = 16;
        texHeight = 16;
    ...
    @Override
    public void setupAnim(BubbleBombEntity entity, float walkAnimPos, float walkAnimSpeed, float ticks, float yRotationOffset, float xRotation) {
